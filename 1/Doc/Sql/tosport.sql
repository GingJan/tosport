...
INSERT INTO `spt_group_info` (`gi_id`, `group_account`, `name`, `creator_id`, `people`, `joined`, `region`, `intro`, `create_time`) VALUES
(1, 'Oscake1', 'Oscake', 1, 50, 0, '深圳', NULL, 1423623958),
(2, 'Oscake2', 'Oscake2', 1, 25, 0, '深圳', '这是Oscake1的分群组', 1423623997),
(3, 'Timky1', 'Timky1', 2, 30, 0, '江门', NULL, 1423624065);
...
INSERT INTO `spt_timeline` (`tl_id`, `sender_id`, `content`, `create_time`, `now_region`, `c_amount`) VALUES
...
(6, 3, 'hello,I''m zjien3.my second test', 1422691883, '广州', 1),
...
(1, 'zjien', 'zjien', '男', '12345678901', '694396727@qq.com', 'abcdefagaga.jpg', 'like machine learning', NULL, '球类', '深圳', 1422431594, '127.0.0.1', 1425885397, '127.0.0.1'),
(2, 'zjien1', 'zjien1', '男', NULL, 'zjien1@qq.com', NULL, NULL, NULL, NULL, '江门', 1422430617, '127.0.0.1', 1423636602, '127.0.0.1'),
(3, 'zjien3', 'zjien3', '男', NULL, 'zjien3@qq.com', NULL, NULL, NULL, NULL, '广州', 1422430669, '127.0.0.1', 1423643216, '127.0.0.1'),
(4, 'xiaoming', 'xiaoming', '男', '', 'xiaoming@qq.com', NULL, NULL, NULL, NULL, '江门', 1420437981, '127.0.0.1', 1423625948, '127.0.0.1'),
