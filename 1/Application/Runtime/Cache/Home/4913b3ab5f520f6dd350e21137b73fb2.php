...
<script type="text/javascript" src="/svn/tosport/1/Public/js/jquery.format.js"></script>
<style type="text/css">
.box {
    margin-top: 40px;
    margin-left: 40px;
                ...
                <div class="box">
                    <div class="col-md-12">
                        <div class="input-group">
                            ...
                            <input id="mz-absurl" type="text" class="form-control" value="/Home/Controller/function" />
                        </div>
                        <!-- /input-group -->
                    </div>
                    <!-- /.col-lg-6 -->
                    ...
                    <input type="radio" name="RequestMethod" class="mz-radio" checked="true" value="POST" />POST
                    <input type="radio" name="RequestMethod" class="mz-radio" value="GET" />GET
...
(function($) {
    ...
    $('#btn-send').on('click', function() {
        ...
        $.ajax({
            type: req_method,
            url: '/svn/tosport/1/index.php' + abs_url,
