...
CREATE TABLE IF NOT EXISTS `spt_date_exercise` (
  ...
  `additional_content` text COMMENT '附加内容',
  ...
  PRIMARY KEY (`de_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='约运动表' AUTO_INCREMENT=4 ;

--
-- 转存表中的数据 `spt_date_exercise`
--

INSERT INTO `spt_date_exercise` (`de_id`, `creator_id`, `sport_type`, `sport_place`, `sport_time`, `additional_content`, `people_amount`, `booked_amount`, `creator_region`, `create_time`) VALUES
(3, 1, '羽毛球', '五邑大学', 1422845000, 'hello', 2, 2, '深圳', 1422844120);
...
(1, 'zjien', 'handsomeguy', '男', '12345678901', 'zjien@qq.com', NULL, 'good man', NULL, NULL, '深圳', 1422431594, '127.0.0.1', 1422843877, '127.0.0.1'),
